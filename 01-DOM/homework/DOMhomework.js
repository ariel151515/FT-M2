...
//  1) Seleccionr el elmento ceuyo id es 'toDoContainer' y almacenarlo en una variable denominada 'toDoContainer'
...
function addToDo() {
  // Tu código acá:
  var value = document.querySelector('#toDoInput').value;
